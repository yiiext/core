 ...
 * CMongoCollection
 */
abstract class CMongoCollection {
    const UNIQUE = 'unique';
     ...
     * id will be
     *
     * @param CMongoModel $object
     * @return CMongoModel
     */
    public function save(CMongoModel $object){
        $data = $object->toArray();
        ...
        return new CMongoModel($data, $this);
    }
     ...
     * @return CMongoQuery
     */
    public function query(CMongoCriteria $criteria = null){
        return new CMongoQuery($this, $criteria);
    }    
    ...
    function createReference(CMongoModel $model){
        return $this->collection->createDBRef($model->toArray());
    }

    function getByReference($reference, $className = 'CMongoModel'){

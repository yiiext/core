 ...
 * in CMongoCollection::documentClass
 *
 */
class CMongoCursor implements Countable, Iterator, ArrayAccess, SeekableIterator {
    /**
     * @var MongoCursor
     */
    private $cursor;
    ...
    function __construct(CMongoCollection $collection, MongoCursor $cursor, CMongoCriteria $criteria){
	...
	public function offsetSet($offset, $value) {
		throw new CMongoException('CMongoCursor is read-only.');
	}

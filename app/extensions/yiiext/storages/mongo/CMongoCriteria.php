...
/** 
 * CMongoCriteria represents a query criteria, such as fields, ordering by, limit/offset. 
 */
class CMongoCriteria {
    const SORT_ASC = 1;
    const SORT_DESC = -1;
    const NO_LIMIT = -1;
     ...
     * 
	 * @param $criteria CMongoCriteria|array the criteria to be merged with.
	 */
